...
export const settingsTable = pgTable("settings", {
  ...
  backupHour: integer("backup_hour").notNull().default(2),
  backupRetention: integer("backup_retention").notNull().default(30),
  backupVpsHost: text("backup_vps_host"),
  backupVpsPort: integer("backup_vps_port").notNull().default(22),
  backupVpsUser: text("backup_vps_user"),
  backupVpsPath: text("backup_vps_path"),
  backupVpsPassword: text("backup_vps_password"),
  backupVpsPrivateKey: text("backup_vps_private_key"),
  backupDriveFolderId: text("backup_drive_folder_id"),
  backupDriveAccessToken: text("backup_drive_access_token"),
